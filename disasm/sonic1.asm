...
StartOfRom:
Vectors:	dc.l $FFFE00, START, Buserr, Addrerr
...
sinset:				; XREF: SS_BGAnimate; et al
		andi.w	#$FF,d0
		add.w	d0,d0
		addi.w	#$80,d0
...
Resize_GHZ3end:
		move.w	scra_h_posit,($FFFFF728).w
		rts	
; ===========================================================================
; ---------------------------------------------------------------------------
...
hashi:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	hashi_Index(pc,d0.w),d1
		jmp	hashi_Index(pc,d1.w)
; ===========================================================================
hashi_Index:	dc.w hashi_Main-hashi_Index, hashi_Action-hashi_Index
		dc.w hashi_Action2-hashi_Index,	hashi_Delete2-hashi_Index
		dc.w hashi_Delete2-hashi_Index,	hashi_Display2-hashi_Index
; ===========================================================================

hashi_Main:				; XREF: hashi_Index
		addq.b	#2,$24(a0)
		move.l	#Map_hashi,4(a0)
		move.w	#$438E,2(a0)
		move.b	#4,actflg(a0)
		move.b	#3,$18(a0)
		move.b	#$80,$19(a0)
...
hashi_Action2:				; XREF: hashi_Index
		bsr.b	hashi_WalkOff
		bsr.w	actionsub
		bra.w	hashi_ChkDel
...
hashi_WalkOff:				; XREF: hashi_Action2
		moveq	#0,d1
		move.b	$28(a0),d1
		lsl.w	#3,d1
		move.w	d1,d2
...
hashi_Bend:				; XREF: hashi_Action; hashi_WalkOff
		move.b	$3E(a0),d0
		bsr.w	sinset
		move.w	d0,d4
...
hashi_ChkDel:				; XREF: hashi_Display; hashi_Action2
		move.w	8(a0),d0
		andi.w	#$FF80,d0
...
hashi_Delete2:				; XREF: hashi_Index
		bsr.w	frameout
		rts	
; ===========================================================================

hashi_Display2:				; XREF: hashi_Index
		bsr.w	actionsub
		rts	
; ===========================================================================
; ---------------------------------------------------------------------------
...
thashi:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	thashi_Index(pc,d0.w),d1
		jmp	thashi_Index(pc,d1.w)
; ===========================================================================
thashi_Index:	dc.w thashi_Main-thashi_Index
		dc.w thashi_Action-thashi_Index
		dc.w thashi_Action-thashi_Index
		dc.w thashi_Delete-thashi_Index
		dc.w thashi_Display-thashi_Index
; ===========================================================================

thashi_Main:				; XREF: thashi_Index
		addq.b	#2,$24(a0)
...
thashi_Action:				; XREF: thashi_Index
...
thashi_RotateSpikes:			; XREF: thashi_Action; thashi_Display
...
thashi_ChkDel:				; XREF: thashi_Action
		move.w	8(a0),d0
		andi.w	#$FF80,d0
		move.w	scra_h_posit,d1
		subi.w	#$80,d1
...
thashi_Delete:				; XREF: thashi_Index
		bsr.w	frameout
		rts	
; ===========================================================================

thashi_Display:				; XREF: thashi_Index
		bsr.w	thashi_RotateSpikes
		bra.w	actionsub
; ===========================================================================
; ---------------------------------------------------------------------------
...
loc_82FC:
		move.b	#0,$3A(a0)
		move.b	#6,$24(a0)	; run "break_Display" routine
...
loc_842E:
		move.b	#0,$3A(a0)
		move.b	#6,$24(a0)	; run "break2_Display" routine
...
usagi:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	usagi_Index(pc,d0.w),d1
		jmp	usagi_Index(pc,d1.w)
; ===========================================================================
usagi_Index:	dc.w usagi_Ending-usagi_Index, loc_912A-usagi_Index
		dc.w loc_9184-usagi_Index, loc_91C0-usagi_Index
		dc.w loc_9184-usagi_Index, loc_9184-usagi_Index
		dc.w loc_9184-usagi_Index, loc_91C0-usagi_Index
		dc.w loc_9184-usagi_Index, loc_9240-usagi_Index
		dc.w loc_9260-usagi_Index, loc_9260-usagi_Index
		dc.w loc_9280-usagi_Index, loc_92BA-usagi_Index
		dc.w loc_9314-usagi_Index, loc_9332-usagi_Index
		dc.w loc_9314-usagi_Index, loc_9332-usagi_Index
		dc.w loc_9314-usagi_Index, loc_9370-usagi_Index
		dc.w loc_92D6-usagi_Index
...
usagi_EndMap:	dc.l flicpat, flicpat, flicpat, usagipat, usagipat
		dc.l usagipat,	usagipat, flicpat, fbutapat, flicpat
		dc.l fbutapat

usagi_EndVram:	dc.w $5A5, $5A5, $5A5, $553, $553, $573, $573, $585, $593
		dc.w $565, $5B3
; ===========================================================================

usagi_Ending:				; XREF: usagi_Index
...
usagi_FromEnemy:			; XREF: usagi_Ending
		addq.b	#2,$24(a0)
		bsr.w	random
		andi.w	#1,d0
		moveq	#0,d1
...
; ===========================================================================
kani_Index:	dc.w kani_Main-kani_Index
...
hachi_Stop:				; XREF: hachi_SetNrSonic
		subq.b	#2,$25(a0)	; run "hachi_Fire" routine
...
loc_9C02:
		...
		swap	d1
		dbra	d1,ring_MakeRings ; repeat for	number of rings

loc_9C0E:
		btst	#0,(a2)
		bne.w	frameout

ring_Animate:				; XREF: ring_Index
...
ring_Sparkle:				; XREF: ring_Index
		lea	(Ani_ring).l,a1
		bsr.w	patchg
		bra.w	actionsub
; ===========================================================================

ring_Delete:				; XREF: ring_Index
		bra.w	frameout
...
flyring:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	flyring_Index(pc,d0.w),d1
		jmp	flyring_Index(pc,d1.w)
; ===========================================================================
flyring_Index:	dc.w flyring_CountRings-flyring_Index
		dc.w flyring_Bounce-flyring_Index
		dc.w flyring_Collect-flyring_Index
		dc.w flyring_Sparkle-flyring_Index
		dc.w flyring_Delete-flyring_Index
; ===========================================================================
...
loc_9CDE:
		subq.w	#1,d5
		move.w	#$288,d4
		bra.b	flyring_MakeRings
; ===========================================================================

flyring_Loop:
		bsr.w	actwkchk
		bne.w	flyring_ResetCounter

flyring_MakeRings:			; XREF: flyring_CountRings
...
flyring_ResetCounter:			; XREF: flyring_Loop
		...
		move.b	#$80,plring_f ; update ring counter
		move.b	#0,plring_f2
		move.w	#$C6,d0
		jsr	(soundset).l ;	play ring loss sound

flyring_Bounce:				; XREF: flyring_Index
		move.b	($FFFFFEC7).w,$1A(a0)
		bsr.w	speedset2
		addi.w	#$18,$12(a0)
		bmi.b	flyring_ChkDel
		move.b	($FFFFFE0F).w,d0
		add.b	d7,d0
		andi.b	#3,d0
		bne.b	flyring_ChkDel
		jsr	ObjHitFloor
		tst.w	d1
		bpl.b	flyring_ChkDel
		add.w	d1,$C(a0)
		move.w	$12(a0),d0
		asr.w	#2,d0
		sub.w	d0,$12(a0)
...
flyring_ChkDel:				; XREF: flyring_Bounce
		tst.b	($FFFFFEC6).w
		beq.b	flyring_Delete
		move.w	($FFFFF72E).w,d0
		addi.w	#$E0,d0
		cmp.w	$C(a0),d0	; has object moved below level boundary?
		bcs.b	flyring_Delete	; if yes, branch
		bra.w	actionsub
; ===========================================================================

flyring_Collect:				; XREF: flyring_Index
		addq.b	#2,$24(a0)
		move.b	#0,$20(a0)
		move.b	#1,$18(a0)
		bsr.w	CollectRing

flyring_Sparkle:				; XREF: flyring_Index
		lea	(Ani_ring).l,a1
		bsr.w	patchg
		bra.w	actionsub
; ===========================================================================

flyring_Delete:				; XREF: flyring_Index
		bra.w	frameout
; ===========================================================================
; ---------------------------------------------------------------------------
...
Obj4B_Collect:				; XREF: Obj4B_Index
		...
		bcs.b	Obj4B_PlaySnd	; if yes, branch
		bset	#0,1(a1)	; reverse flash	object

Obj4B_PlaySnd:
		move.w	#$C3,d0
		jsr	(soundset).l ;	play giant ring	sound
		bra.b	Obj4B_Animate
; ===========================================================================
...
item_Main:				; XREF: item_Index
		...
		move.b	#8,$24(a0)	; run "item_Display" routine
...
mogura_Main:				; XREF: mogura_Index
		...
		move.b	#5,$20(a0)
		move.b	#$C,$19(a0)
		addq.b	#6,$25(a0)	; run "mogura_ChkSonic" routine
		move.b	#2,$1C(a0)
...
jyama:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	jyama_Index(pc,d0.w),d1
		jmp	jyama_Index(pc,d1.w)
; ===========================================================================
jyama_Index:	dc.w jyama_Main-jyama_Index
		dc.w jyama_Solid-jyama_Index
; ===========================================================================

jyama_Main:				; XREF: jyama_Index
		addq.b	#2,$24(a0)
		move.l	#jyamapat,4(a0)
		move.w	#$63D0,2(a0)
		move.b	#4,1(a0)
		move.b	#$13,$19(a0)
		move.b	#4,$18(a0)

jyama_Solid:				; XREF: jyama_Index
		move.w	#$1B,d1
		move.w	#$10,d2
		move.w	#$10,d3
		move.w	8(a0),d4
...
Obj49_PlaySnd:				; XREF: Obj49_Index
		...
		bne.b	Obj49_ChkDel
		move.w	#$D0,d0
		jsr	(soundset).l ;	play waterfall sound
...
brkabe:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	brkabe_Index(pc,d0.w),d1
		jsr	brkabe_Index(pc,d1.w)
		bra.w	frameoutchk
; ===========================================================================
brkabe_Index:	dc.w brkabe_Main-brkabe_Index
		dc.w brkabe_Solid-brkabe_Index
		dc.w brkabe_FragMove-brkabe_Index
; ===========================================================================

brkabe_Main:				; XREF: brkabe_Index
		addq.b	#2,$24(a0)
...
brkabe_Solid:				; XREF: brkabe_Index
...
brkabe_ChkRoll:				; XREF: brkabe_Solid
...
brkabe_FragMove:				; XREF: brkabe_Index
		bsr.w	speedset2
...
act_tbl:
		...
		dc.l	Obj29,door,fish,fish2,mogura,item2,yuka,ochi
		...
		dc.l	Obj49,Obj4A,Obj4B,myogan,yogan,yogan2,usa,yado
...
loc_D646:
		...
		dbra	d0,loc_D646	; repeat $F times (length of object RAM)
		rts	
; End of function frameout
...
sjump_Main:				; XREF: sjump_Index
		...
		move.b	#8,$24(a0)	; use "sjump_LR" routine
		move.b	#1,$1C(a0)
		move.b	#3,$1A(a0)
		move.w	#$533,2(a0)
		move.b	#8,$19(a0)
...
loc_DB54:
		...
		move.b	#$E,$24(a0)	; use "sjump_Dwn" routine
		bset	#1,$22(a0)
...
sjump_ResetUp:				; XREF: sjump_Index
		move.b	#1,$1D(a0)	; reset	animation
		subq.b	#4,$24(a0)	; goto "sjump_Up" routine
		rts	
; ===========================================================================
...
sjump_ResetLR:				; XREF: sjump_Index
		...
		subq.b	#4,$24(a0)	; goto "sjump_LR" routine
		rts	
; ===========================================================================
...
sjump_ResetDwn:				; XREF: sjump_Index
		move.b	#1,$1D(a0)	; reset	animation
		subq.b	#4,$24(a0)	; goto "sjump_Dwn" routine
		rts	
; ===========================================================================
Ani_sjump:
...
fire_Type00:				; XREF: fire_TypeIndex
		...
		addq.b	#2,$24(a0)	; goto "fire_Delete" routine
...
yoganc_Main:				; XREF: yoganc_Index
		...
		moveq	#0,d0
		move.b	$28(a0),d0
		move.b	yoganc_Sizes(pc,d0.w),$20(a0)
...
water:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	water_Index(pc,d0.w),d1
		jmp	water_Index(pc,d1.w)
; ===========================================================================
water_Index:	dc.w water_Main-water_Index
		dc.w water_Action-water_Index
; ===========================================================================

water_Main:				; XREF: water_Index
		addq.b	#2,$24(a0)
		move.l	#Map_water,4(a0)
		move.w	#$C300,2(a0)
		move.b	#4,1(a0)
		move.b	#$80,$19(a0)
		move.w	8(a0),$30(a0)

water_Action:				; XREF: water_Index
		move.w	scra_h_posit,d1
		andi.w	#$FFE0,d1
		add.w	$30(a0),d1
		btst	#0,($FFFFFE05).w
...
yari_Move:				; XREF: yari_Index
		...
		move.b	yari_Data(pc,d0.w),$20(a0) ; load collision response (based on	d0)
		bra.w	frameoutchk
; ===========================================================================
...
yari_Wait:				; XREF: yari_Index
		...
		bpl.b	yari_ChkDel
		move.w	#60,$30(a0)
		subq.b	#2,$24(a0)	; run "yari_Move" subroutine
...
play00:					; XREF: act_tbl
		tst.w	editmode	; is debug mode	being used?
		beq.b	play00_Normal	; if not, branch
		jmp	edit
; ===========================================================================
...
play00_Normal:
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	play00_Index(pc,d0.w),d1
		jmp	play00_Index(pc,d1.w)
; ===========================================================================
play00_Index:	dc.w play00_Main-play00_Index
		dc.w play00_Control-play00_Index
		dc.w play00_Hurt-play00_Index
		dc.w play00_Death-play00_Index
		dc.w play00_ResetLevel-play00_Index
; ===========================================================================

play00_Main:				; XREF: play00_Index
		addq.b	#2,$24(a0)
		move.b	#$13,$16(a0)
		move.b	#9,$17(a0)
		move.l	#playpat,4(a0)
...
play00_Control:				; XREF: play00_Index
		tst.w	debugflag	; is debug cheat enabled?
		beq.b	loc_12C58	; if not, branch
		btst	#4,swdata1+1 ; is button C pressed?
		beq.b	loc_12C58	; if not, branch
		move.w	#1,editmode ; change Sonic	into a ring/item
		clr.b	($FFFFF7CC).w
		rts	
; ===========================================================================
...
loc_12C58:
		...
		bne.b	loc_12C64	; if yes, branch
		move.w	swdata1+0,swdata+0 ; enable joypad control

loc_12C64:
		btst	#0,($FFFFF7C8).w ; are controls	locked?
		bne.b	loc_12C7E	; if yes, branch
		moveq	#0,d0
		move.b	$22(a0),d0
		andi.w	#6,d0
		move.w	play00_Modes(pc,d0.w),d1
		jsr	play00_Modes(pc,d1.w)
...
loc_12CB6:
		...
		rts	
; ===========================================================================
play00_Modes:	dc.w play00_MdNormal-play00_Modes
		dc.w play00_MdJump-play00_Modes
		dc.w play00_MdRoll-play00_Modes
		dc.w play00_MdJump2-play00_Modes
; ---------------------------------------------------------------------------
...
Sonic_Display:				; XREF: loc_12C7E
		move.w	$30(a0),d0
		beq.b	play00_Display
		subq.w	#1,$30(a0)
		lsr.w	#3,d0
		bcc.b	play00_ChkInvin
...
play00_ChkInvin:
		...
		bne.b	play00_ChkShoes
		tst.b	($FFFFF7AA).w
		bne.b	play00_RmvInvin
		cmpi.w	#$C,pl_air
		bcs.b	play00_RmvInvin
		moveq	#0,d0
		move.b	stageno,d0
		cmpi.w	#$103,stageno ; check if level is	SBZ3
		bne.b	play00_PlayMusic
...
Sonic_RecordPos:			; XREF: loc_12C7E; play00_Hurt; play00_Death
...
plwaterchk:				; XREF: loc_12C7E
		cmpi.b	#1,stageno ; is level LZ?
		beq.b	play00_InWater	; if yes, branch
...
play00_InWater:
		...
		bge.b	play00_OutWater	; if yes, branch
		bset	#6,$22(a0)
		bne.b	locret_12D80
		bsr.w	ResumeMusic
		...
		move.w	#$AA,d0
		jmp	(soundset).l ;	play splash sound
; ===========================================================================
...
play00_MdNormal:				; XREF: play00_Modes
		bsr.w	Sonic_Jump
...
play00_MdJump:				; XREF: play00_Modes
		bsr.w	jumpchk2
		bsr.w	jumpmove
		bsr.w	limitchk
		jsr	speedset
...
play00_MdRoll:				; XREF: play00_Modes
		bsr.w	Sonic_Jump
		bsr.w	ballchkRepel
		bsr.w	ballchkSpeed
		bsr.w	limitchk
...
play00_MdJump2:				; XREF: play00_Modes
		bsr.w	jumpchk2
		bsr.w	jumpmove
		bsr.w	limitchk
		jsr	speedset
...
Sonic_Move:				; XREF: play00_MdNormal
...
ballchkSpeed:			; XREF: play00_MdRoll
		move.w	($FFFFF760).w,d6
		asl.w	#1,d6
		move.w	($FFFFF762).w,d5
		asr.w	#1,d5
		...
		bne.b	loc_13188
		btst	#2,swdata+0 ; is left being pressed?
		beq.b	loc_1317C	; if not, branch
		bsr.w	ballchkLeft

loc_1317C:
		btst	#3,swdata+0 ; is right being pressed?
		beq.b	loc_13188	; if not, branch
		bsr.w	ballchkRight
...
loc_131FA:
		move.w	d1,$10(a0)
		bra.w	loc_1300C
; End of function ballchkSpeed


; ||||||||||||||| S U B	R O U T	I N E |||||||||||||||||||||||||||||||||||||||


ballchkLeft:				; XREF: ballchkSpeed
		move.w	$14(a0),d0
		beq.b	loc_1320A
		bpl.b	loc_13218
...
loc_13220:
		move.w	d0,$14(a0)
		rts	
; End of function ballchkLeft


; ||||||||||||||| S U B	R O U T	I N E |||||||||||||||||||||||||||||||||||||||


ballchkRight:			; XREF: ballchkSpeed
		move.w	$14(a0),d0
		bmi.b	loc_1323A
		bclr	#0,$22(a0)
		move.b	#2,$1C(a0)	; use "rolling"	animation
...
jumpmove:			; XREF: play00_MdJump; play00_MdJump2
		move.w	($FFFFF760).w,d6
		move.w	($FFFFF762).w,d5
		asl.w	#1,d5
		btst	#4,$22(a0)
...
limitchk:			; XREF: play00_MdNormal; et al
		move.l	8(a0),d1
		move.w	$10(a0),d0
		ext.l	d0
		asl.l	#8,d0
...
?jump:
		...
		move.b	#14,sprhsize(a0)
		move.b	#7,sprvsize(a0)
		move.b	#2,mstno(a0)
		addq.w	#5,yposi(a0)
		move.w	#$BE,d0
		jsr		soundset
...
Sonic_Jump:				; XREF: play00_MdNormal; play00_MdRoll
		move.b	($FFFFF603).w,d0
...
jumpchk2:			; XREF: play00_MdJump; play00_MdJump2
		tst.b	$3C(a0)
		beq.b	loc_134C4
		move.w	#-$400,d1
		btst	#6,$22(a0)
...
Sonic_SlopeResist:			; XREF: play00_MdNormal
		move.b	$26(a0),d0
		addi.b	#$60,d0
		cmpi.b	#$C0,d0
		bcc.b	locret_13508
...
ballchkRepel:			; XREF: play00_MdRoll
		move.b	$26(a0),d0
		addi.b	#$60,d0
		cmpi.b	#-$40,d0
		bcc.b	locret_13544
...
Sonic_SlopeRepel:			; XREF: play00_MdNormal; play00_MdRoll
		nop	
		tst.b	$38(a0)
		bne.b	locret_13580
		tst.w	$3E(a0)
...
Sonic_JumpAngle:			; XREF: play00_MdJump; play00_MdJump2
...
Sonic_Floor:				; XREF: play00_MdJump; play00_MdJump2
		move.w	$10(a0),d1
		move.w	$12(a0),d2
		jsr	(atan).l
...
jumpcolsub:			; XREF: PlatformObject; et al
		btst	#4,$22(a0)
		beq.b	loc_137AE
		nop	
		nop	
...
Sonic_HurtStop:				; XREF: play00_Hurt
		move.w	($FFFFF72E).w,d0
		addi.w	#$E0,d0
		cmp.w	$C(a0),d0
		bcs.w	playdieset
...
play00_Death:				; XREF: play00_Index
		bsr.w	GameOver
		jsr	speedset
		bsr.w	Sonic_RecordPos
		bsr.w	spatset
...
play00_ResetLevel:			; XREF: play00_Index
		tst.w	$3A(a0)
		beq.b	locret_13914
		subq.w	#1,$3A(a0)	; subtract 1 from time delay
		bne.b	locret_13914
...
Sonic_Loops:				; XREF: play00_Control
		cmpi.b	#3,stageno ; is level SLZ	?
		beq.b	loc_13926	; if yes, branch
		tst.b	stageno	; is level GHZ ?
...
spatset:				; XREF: play00_Control; et al
...
Loadplaywrtpat:			; XREF: play00_Control; et al
		moveq	#0,d0
...
ResumeMusic:				; XREF: awa_Wobble; plwaterchk; plawa_ReduceAir
		...
		cmpi.w	#$103,stageno ; check if level is	0103 (SBZ3)
		bne.b	loc_140A6
...
Sonic_AnglePos:				; XREF: play00_MdNormal; play00_MdRoll
		btst	#3,$22(a0)
		beq.b	loc_14602
		moveq	#0,d0
...
loc_16ABC:
		move.b	#$A,$24(a0)	; run "imo_Delete" routine
		rts	
; ===========================================================================
...
save:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	save_Index(pc,d0.w),d1
		jsr	save_Index(pc,d1.w)
		jmp	frameoutchk
; ===========================================================================
save_Index:	dc.w save_Main-save_Index
		dc.w save_BlueLamp-save_Index
		dc.w save_AfterHit-save_Index
		dc.w save_Twirl-save_Index
; ===========================================================================

save_Main:				; XREF: save_Index
		addq.b	#2,$24(a0)
		move.l	#savepat,4(a0)
		move.w	#$7A0,2(a0)
		move.b	#4,1(a0)
		...
		bcs.b	save_BlueLamp	; if yes, branch

save_RedLamp:
		bset	#0,2(a2,d0.w)
		move.b	#4,$24(a0)	; run "save_AfterHit" routine
		move.b	#3,$1A(a0)	; use red lamppost frame
		rts	
; ===========================================================================

save_BlueLamp:				; XREF: save_Index
		tst.w	editmode	; is debug mode	being used?
...
save_HitLamp:
		...
		bcc.b	locret_16F90
		move.w	#$A1,d0
		jsr	(soundset).l ;	play lamppost sound
		addq.b	#2,$24(a0)
		jsr	actwkchk
		bne.b	loc_16F76
		move.b	#$79,0(a1)	; load twirling	lamp object
		move.b	#6,$24(a1)	; use "save_Twirl" routine
		move.w	8(a0),$30(a1)
		move.w	$C(a0),$32(a1)
		subi.w	#$18,$32(a1)
		move.l	#savepat,4(a1)
...
save_AfterHit:				; XREF: save_Index
		rts	
; ===========================================================================

save_Twirl:				; XREF: save_Index
		subq.w	#1,$36(a0)
		bpl.b	loc_16FA0
		move.b	#4,$24(a0)
...
playsave:			; XREF: save_HitLamp
		...
		move.b	plring_f2,($FFFFFE54).w 	; lives
		...
		move.w	scra_h_posit,($FFFFFE40).w 	; screen x-position
		move.w	scra_v_posit,($FFFFFE42).w 	; screen y-position
		move.w	($FFFFF708).w,($FFFFFE44).w 	; bg position
		move.w	scrb_v_posit,($FFFFFE46).w 	; bg position
...
playload:				; XREF: scr_set
		...
		move.w	($FFFFFE3E).w,scralim_n_down
		move.w	($FFFFFE40).w,scra_h_posit
		move.w	($FFFFFE42).w,scra_v_posit
		move.w	($FFFFFE44).w,($FFFFF708).w
		move.w	($FFFFFE46).w,scrb_v_posit
...
bten:					; XREF: act_tbl
		moveq	#0,d0
		move.b	$24(a0),d0
		move.w	bten_Index(pc,d0.w),d1
		jmp	bten_Index(pc,d1.w)
; ===========================================================================
bten_Index:	dc.w bten_Main-bten_Index
		dc.w bten_DelayDel-bten_Index
; ===========================================================================

bten_Main:				; XREF: bten_Index
		moveq	#$10,d2
		move.w	d2,d3
		add.w	d3,d3
		lea	playerwk,a1
		...
		move.w	#$C9,d0
		jsr	(soundset).l ;	play bonus sound
		moveq	#0,d0
		move.b	$28(a0),d0
		add.w	d0,d0
		move.w	bten_Points(pc,d0.w),d0 ; load	bonus points array
		jsr	scoreup
...
bten_Delete:
		jmp	frameout
; ===========================================================================
bten_Points:	dc.w 0			; Bonus	points array
		dc.w 1000
		dc.w 100
		dc.w 1
; ===========================================================================

bten_DelayDel:				; XREF: bten_Index
		subq.w	#1,$30(a0)	; subtract 1 from display time
		bmi.b	bten_Delete2	; if time is zero, branch
		move.w	8(a0),d0
		andi.w	#-$80,d0
		move.w	scra_h_posit,d1
		subi.w	#$80,d1
...
play01_GOAL:
		...
		addq.b	#2,$24(a0)	; run routine "play01_ExitStage"
...
ddev18:	dc.w 2
		...
		dc.w $96C0
		dc.l ebigringcg	; giant	ring flash effect
		dc.w $8C40
...
savecg:	incbin	artnem\lamppost.bin	; lamppost
		even
ebigringcg:	incbin	artnem\rngflash.bin	; flash from giant ring
		even
